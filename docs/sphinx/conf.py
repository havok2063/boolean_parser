...
from boolean_parser import __version__
...
issues_github_path = 'havok2063/boolean_parser'
...
.. |boolean_parser_version| replace:: {__version__}
"""
...
if sphinx_template == 'sphinx-bootstrap':
    ...
    html_theme_options = {
        ...
        'navbar_title': "Project: {0}".format(project),
    ...
    html_logo = '_static/fuzzy_types_logo.png'
...
htmlhelp_basename = '{0}pdoc'.format('boolean_parser')
...
man_pages = [
    (master_doc, 'boolean_parser', u'{0} Documentation'.format(project),
     [author], 1)
]
