...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("modela.dates = 2020-01-01", "modela.dates = '2020-01-01'"),
        ("modela.datetimes == 2020-01-01T00:00:00", "modela.datetimes = '2020-01-01 00:00:00'",),
        ("modela.datetimes == 2020-01-01T00:00", "modela.datetimes = '2020-01-01 00:00:00'",),
        ("modela.datetimes == 2020-01-01T00", "modela.datetimes = '2020-01-01 00:00:00'",),
        ("modela.datetimes == 2020-01-01", "modela.datetimes = '2020-01-01 00:00:00'",),
    ],
    ids=[
        "gt",
        "lt",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("modela.datetimes < 2020-01-01T00:00:00", 20),
        ("modela.datetimes < 2020-01-01T00:00", 20),
        ("modela.datetimes < 2020-01-01T00", 20),
        ("modela.datetimes < 2020-01-01", 20),
